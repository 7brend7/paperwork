$(function() {
    ...
    $('.notebook-controls button').tooltip();
    ...
    if(matchMedia('(max-width: 991px)').matches) {
        ...
        snapper.on('animated', function(){
            if(!$('body').hasClass('snapjs-left')) {
                $('.mobile-show-navigation .sidebar-toggle-hidden').hide();
            }
        });
        ...
        $('#notesListViewParent').add($('#paperworkViewParent')).wrapAll(
    ...
    $('#wayback-machine').on('show.freqselector', function() {
        $(this).addClass('expanded');
    });

    $('#wayback-machine').on('hide.freqselector', function() {
