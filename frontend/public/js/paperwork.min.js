...
paperworkModule.factory('MessageBoxService',
...
paperworkModule.factory('NotesService',
   ...
   function($scope, $rootScope, $location, $routeParams, notesService) {
     ...
     if(typeof searchMatch != "undefined" && searchMatch != null && searchMatch.length > 0) {
       switch(searchMatch[1]) {
         case "tagid":
           notesService.getNotesInTag(searchMatch[3]);
           break;
         default:
...
paperworkModule.controller('ViewController',
  ['$scope', '$rootScope', '$location', '$routeParams', 'NotesService',
   function($scope, $rootScope, $location, $routeParams, notesService) {
     $scope.isVisible = function() {
       return !$rootScope.expandedNoteLayout;
